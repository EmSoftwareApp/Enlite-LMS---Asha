...
{{ App\Models\
        ...
        <div class="mdk-header-layout__content">{{ App\Models\
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                  ...
                                  <form action="{{ url('/update-topic') }}" id="form_sample_1" method="post" enctype="multipart/form-data" >
                                    ...
                                    <div class="card-form__body card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6 col-lg">
                                                ...
                                                <input id="fname" type="text" class="form-control" placeholder="Enter Topic Name here" name="topicname" value="{{ $object->topicname }}" required="">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12 col-lg">
                                                ...
                                                <textarea id="editor1" class="form-control" rows="15" cols="80" placeholder="Enter Description here" name="description">{{ $object->description }}</textarea>
