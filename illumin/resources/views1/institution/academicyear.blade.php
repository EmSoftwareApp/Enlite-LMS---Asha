                ...
                <div class="mdk-drawer-layout__content page">
                    ...
                    <div class="container-fluid page__heading-container">
                        ...
                        <div class="page__heading d-flex align-items-center justify-content-between">
                            ...
                            <h4 class="m-0">Academic Year Management</h4>



                            <a href="{{ url('/new-acdemicyear') }}">

                                <!--<button type="button" class="btn btn-primary btn-sm">New Program</button>-->

                                <button type="button" class="btn btn-warning">

                                    <i class="fa fa-calendar-alt"></i> New Academic Year
                                                ...
                                                <table id="example" class="display" style="width:100%">
                                                    ...
                                                    <thead>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th style="width: 85%;">Accademic Year</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="media align-items-center">
                                                                    ...
                                                                    <div class="media-body">
		                                                            	...
		                                                            	{{ Carbon\Carbon::parse($date1)->format('j F Y') }} - {{ Carbon\Carbon::parse($date2)->format('j F Y') }}
                                                            ...
                                                            <td align="center">
                                                                ...
                                                                <!--<a href="{{ url('view-academicyear/'.$object->id) }}" class="text-muted">

                                                                    <i class="fa fa-edit"></i>

                                                                </a>-->

                                                                <a href="{{ url('academicyear-remove/'.$object->id) }}" class="text-muted" onclick="return confirm('Are you sure to Delete??');">
