                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                  ...
                                  <form action="{{ url('/update-state') }}" id="form_sample_1" method="post" enctype="multipart/form-data" >
                                    ...
                                    <div class="card-form__body card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12 col-lg">
                                                ...
                                                <input id="fname" type="text" class="form-control" placeholder="Enter State Name here" name="state" value="{{ $object->state }}" required="">
