...
{{ App\Models\
                    ...
                    <div class="container-fluid page__heading-container">
                        ...
                        <div class="page__heading d-flex align-items-center justify-content-between">
                            ...
                            <h4 class="m-0">Topic Management</h4>
                            ...
                            <a href="{{ url('/new-topic') }}">
                                ...
                                <button type="button" class="btn btn-warning">
                                    ...
                                    <i class="fa fa-paper-plane"></i> New Topic
                                                ...
                                                <table id="example" class="display" style="width:100%">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="center"><a href="{{ url('view-topic/'.$object->id) }}">{{ $i }}</a></td>

                                                            <td>

                                                                <div class="media align-items-center">

                                                                    <div class="media-body" data-toggle="tooltip" title="{{ substr(strip_tags($object->description), 0,  100) }}">

                                                                        <span class="js-lists-values-employee-name">{{ $object->topicname }}</span>
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="media align-items-center">
                                                                    ...
                                                                    <div class="media-body">
                                                                        ...
                                                                        <span class="js-lists-values-employee-name" data-toggle="tooltip" title="{{ substr(strip_tags($object->description), 0,  100) }}">{{ App\Models\tblBasicSettings::coursefind($object->course) }}</span>
                                                            ...
                                                            <td align="center">
                                                                ...
                                                                <a href="{{ url('topic-progrm-assign/'.$object->id) }}" data-toggle="tooltip" title="View Assigned Programs">
                                                            ...
                                                            <td align="center">
                                                                ...
                                                                <a href="{{ url('view-topic/'.$object->id) }}" class="text-muted">

                                                                    <i class="fa fa-edit"></i>

                                                                </a>

                                                                <a href="{{ url('topic-remove/'.$object->id) }}" class="text-muted" onclick="return confirm('Are you sure to Delete??');">
        ...
        if (checkBox.checked == true){
...

            {
                ...
                $.ajax({
                    ...
                    url: "<?php echo route('topic-approve') ?>",
...

            {
                ...
                $.ajax({
                    ...
                    url: "<?php echo route('topic-reject') ?>",
