...
{{ App\Models\
                    ...
                    <div class="container-fluid page__heading-container">
                        ...
                        <div class="page__heading d-flex align-items-center justify-content-between">
                            ...
                            <h4 class="m-0">View Student Batch</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                  ...
                                  <form action="{{ url('/update-batch') }}" id="form_sample_1" method="post" enctype="multipart/form-data" >
                                    ...
                                    <div class="card-form__body card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-4 col-lg">
                                                ...
                                                <input id="fname" type="text" class="form-control" placeholder="Enter Batch Name here" name="batchname" value="{{ $object->batchname }}" required="">
                                            ...
                                            <div class="col-md-4 col-lg">
                                                ...
                                                <select class="form-control" name="acdyear" required="">
                                                    ...
                                                    <option value="">Choose Accademic Year</option>
                                                    ...
                                                    ?>
                                                     ...
                                                     <option value="{{ $acyrs->id }}" @if($acyrs->id == $object->acdyear) selected="selected" @endif>{{ Carbon\Carbon::parse($date1)->format('j F Y') }} - {{ Carbon\Carbon::parse($date2)->format('j F Y') }}</option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-4 col-lg">
                                                ...
                                                <input id="" type="text" name="batchstart" class="form-control"  placeholder="Enter Batch Start Date here" data-toggle="flatpickr" value="{{ $object->batchstart }}">

                                            </div>

                                            <div class="col-md-4 col-lg">

                                                <label for="fname">Batch End Date</label>

                                                <input id="" type="text" class="form-control" placeholder="Enter Batch End Date here" name="batchend" data-toggle="flatpickr" value="{{ $object->batchend }}" >

                                            </div>

                                            <div class="col-md-4 col-lg">

                                                <label for="fname">Max No of Students*</label>

                                                <input id="fname" type="text" class="form-control" placeholder="Enter Max No of Students here" name="noofstudents" onkeypress="return isNumberKey(event)" maxlength="4" required="" value="{{ $object->noofstudents }}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12 col-lg">
                                                ...
                                                <label for="fname"> Batch Description</label>

                                                <textarea class="form-control" placeholder="Enter Batch Description here" name="description" rows="5" cols="80" >{{ $object->description }}</textarea>
