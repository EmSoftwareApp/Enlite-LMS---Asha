...
<head>
    ...
    <title>{{ App\Models\tblSystemSettigs::systemname('systemname') }} | States Management</title>
                ...
                <div class="mdk-drawer-layout__content page">
                    ...
                    <div class="container-fluid page__heading-container">
                        ...
                        <div class="page__heading d-flex align-items-center justify-content-between">
                            ...
                            <h4 class="m-0">States Management</h4>



                            <a href="{{ url('/new-state') }}">

                                <!--<button type="button" class="btn btn-primary btn-sm">New Course</button>-->

                                <button type="button" class="btn btn-warning">

                                    <i class="fa fa-paper-plane"></i> New State
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="media align-items-center">
                                                                    ...
                                                                    <div class="media-body">
                                                                        ...
                                                                        <span class="js-lists-values-employee-name">{{ $object->state }}</span>
                                                            ...
                                                            <td align="center">
                                                                ...
                                                                <a href="{{ url('view-state/'.$object->id) }}" class="text-muted">

                                                                    <i class="fa fa-edit"></i>

                                                                </a>

                                                                <a href="{{ url('state-remove/'.$object->id) }}" class="text-muted" onclick="return confirm('Are you sure to Delete??');">
        ...
        if (checkBox.checked == true){
...

            {
                ...
                $.ajax({
                    ...
                    url: "<?php echo route('state-approve') ?>",
...

            {
                ...
                $.ajax({
                    ...
                    url: "<?php echo route('state-reject') ?>",
