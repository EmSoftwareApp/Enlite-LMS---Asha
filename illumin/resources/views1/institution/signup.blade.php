...
<body class="layout-login-centered-boxed">
    <div class="layout-login-centered-boxed__form">
        ...
        <div class="card card-body">
            ...
            <form action="{{ url('/inst-register') }}" method="post">
                {{ csrf_field() }}
                @if(count($errors)>0)
                ...
                <div class="form-group">
                    <label class="text-label" for="name_2">Institute Name:</label>
                    <div class="input-group input-group-merge">
                        <input id="name_2" type="text" required="" class="form-control form-control-prepended" placeholder="Institute Name" name="name">
                ...
                <div class="form-group">
                    <label class="text-label" for="name_2">Contact No:</label>
                    <div class="input-group input-group-merge">
                        <input id="name_2" type="text" required="" class="form-control form-control-prepended" placeholder="Contact Number" name="contact" minlength="10" maxlength="10" onkeypress="return isNumberKey(event)">
                        <div class="input-group-prepend">
                            <div class="input-group-text">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group input-group-merge">
                        <input id="email_2" type="email" required="" name="email" class="form-control form-control-prepended" placeholder="Email Address">
                        <div class="input-group-prepend">
                            <div class="input-group-text">
                ...
                <div class="text-center">
                    <span>Have an account?</span> <a class="text-body text-underline" href="{{ url('/site-manager') }}"> Login</a>
                </div>
            </form>
        </div>
    </div>
