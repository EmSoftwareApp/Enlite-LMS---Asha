                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                  ...
                                  <form action="{{ url('/post-video') }}" id="form_sample_1" method="post" enctype="multipart/form-data" onSubmit="return validateForm()">
                                    ...
                                    <div class="card-form__body card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-4 col-lg">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter Video Caption here" name="videocaption" value="" required="">
...
<div class="form-group row">
                                            ...
                                            <div class="col-md-4 col-lg">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter Minutes(Eg:00)" name="duration_min" value="" required="">
                                                </div> <div class="col-md-4 col-lg">
                                                 <label for="fname"></label>
                                                <input type="text" class="form-control" placeholder="Enter Seconds(Eg:00)" name="duration_sec" value="" required="">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12 col-lg">
                                                ...
                                                <label for="fname">Description</label>
                                                 ...
                                                 <textarea id="editor1" name="description" rows="15" cols="80" placeholder="Video Description Added Here..">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6 col-lg">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter Meta Title here" name="metatitle" value="">
                                            ...
                                            <div class="col-md-6 col-lg">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter Keywords here" name="keywords" value="">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12 col-lg">
                                                ...
                                                <textarea class="form-control" placeholder="Enter Meta Description here" name="metadescription"></textarea>
