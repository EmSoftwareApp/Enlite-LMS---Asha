...
<head>
    ...
    <title>{{ App\Models\tblSystemSettigs::systemname('systemname') }} | Student notification Management</title>
                ...
                <div class="mdk-drawer-layout__content page">
                    ...
                    <div class="container-fluid page__heading-container">
                        ...
                        <div class="page__heading d-flex align-items-center justify-content-between">
                            ...
                            <h4 class="m-0">Student notification Management</h4>
                            ...
                            <a href="{{ url('/new-notification') }}">
                                ...
                                <button type="button" class="btn btn-warning">
                                    ...
                                    <i class="fa fa-users-cog"></i> New Student notification
                                                ...
                                                <table id="example" class="display" style="width:100%">
                                                    ...
                                                    <thead>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th style="width: 15%;">Notify Till Date</th>
...
<div class="media align-items-center">
    ...
    <div class="media-body">
        ...
        <span class="js-lists-values-employee-name">{{ $object->message }}</span>
...
<td>
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="media align-items-center">
                                                                    ...
                                                                    <div class="media-body">
                                                                        ...
                                                                        <span class="js-lists-values-employee-name">{{ Carbon\Carbon::parse($object->till_date)->format('j F Y') }}</span>
                                                            ...
                                                            <td align="center">
                                                                ...
                                                                <a href="{{ url('view-notification/'.$object->id) }}" class="text-muted">

                                                                    <i class="fa fa-edit"></i>

                                                                </a>

                                                                <a href="{{ url('notification-remove/'.$object->id) }}" class="text-muted" onclick="return confirm('Are you sure to Delete??');">
  ...
  $(function () {
...

    {
...

        {
            ...
            window.location.href=cur_url+'/student-notification-find/'+x;
        ...
        if (checkBox.checked == true){
...

            {
                ...
                $.ajax({
                    ...
                    url: "<?php echo route('notification-approve') ?>",
...

            {
                ...
                $.ajax({
                    ...
                    url: "<?php echo route('notification-reject') ?>",
