...
<head>
    ...
    <title>{{ App\Models\tblSystemSettigs::systemname('systemname') }} | Test Difficulty</title>
...
<body class="layout-default">
                ...
                <div class="mdk-drawer-layout__content page">
                    ...
                    <div class="container-fluid page__heading-container">
                        <div class="page__heading d-flex align-items-center justify-content-between">
                            <h4 class="m-0">New Test Difficulty</h4>

                            <a href="{{ url('/test-difficulty') }}"><button type="button" class="btn btn-warning"><i class="fa fa-step-backward"></i>&nbsp;Back</button></a>
                        </div>
                    </div>
                    ...
                    <div class="container-fluid page__container">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                  <form action="{{ url('/post-test-difficulty') }}" id="form_sample_1" method="post" enctype="multipart/form-data" >
                                  {{ csrf_field() }}
                                    <div class="card-form__body card-body">
                                        ...
                                        <div class="form-group row" id="chpater-row{{$k}}" @if($k != '1') style="display: none;" @endif>
                                            <div class="col-md-4 col-lg">
                                                ...
                                                <input id="level{{ $k }}" type="text" class="form-control" placeholder="Enter Level here" name="level{{ $k }}">
                                            </div>
                                            <div class="col-md-4 col-lg">
                                                <label for="fname">Level Short Name</label>
                                                <input id="shortname{{ $k }}" type="text" class="form-control" placeholder="Enter Level Short Name here" name="shortname{{ $k }}">
                                            </div>
                                            <div class="col-md-4 col-lg">
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <input type="submit" class="btn btn-success" value="Save Designation"/>
                                    </div>
                                  </form>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        function removerow(x)
        {
            ...
            document.getElementById('level'+x).value = '';
            document.getElementById('shortname'+x).value = '';
