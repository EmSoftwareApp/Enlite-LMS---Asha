                ...
                <div class="mdk-drawer-layout__content page">
                    ...
                    <div class="container-fluid page__heading-container">
                        ...
                        <div class="page__heading d-flex align-items-center justify-content-between">
                            ...
                            <h4 class="m-0">Test Difficulty</h4>



                            <a href="{{ url('/new-test-difficulty') }}">

                                <!--<button type="button" class="btn btn-primary btn-sm">New Course</button>-->

                                <button type="button" class="btn btn-warning">

                                    <i class="fa fa-hard-hat"></i> New Test Difficulty Level
                                                ...
                                                <table id="example" class="display" style="width:100%">
                                                    ...
                                                    <thead>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th style="width: 30%;">Level Name</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="media align-items-center">
                                                                    ...
                                                                    <div class="media-body">
                                                                        ...
                                                                        <span class="js-lists-values-employee-name">{{ $object->level }}</span>
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="media align-items-center">
                                                                    ...
                                                                    <div class="media-body">
                                                                        ...
                                                                        <span class="js-lists-values-employee-name">{{ $object->shortname }}</span>
                                                            ...
                                                            <td align="center">
                                                                ...
                                                                <a href="{{ url('view-test-difficulty/'.$object->id) }}" class="text-muted">

                                                                    <i class="fa fa-edit"></i>

                                                                </a>

                                                                <a href="{{ url('test-difficulty-remove/'.$object->id) }}" class="text-muted" onclick="return confirm('Are you sure to Delete??');">
        ...
        if (checkBox.checked == true){
...

            {
                ...
                $.ajax({
                    ...
                    url: "<?php echo route('test-difficulty-approve') ?>",
...

            {
                ...
                $.ajax({
                    ...
                    url: "<?php echo route('test-difficulty-reject') ?>",
