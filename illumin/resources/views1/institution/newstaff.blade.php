                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                  ...
                                  <form action="{{ url('/post-staff') }}" id="form_sample_1" method="post" enctype="multipart/form-data" >
                                    ...
                                    <div class="card-form__body card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-4 col-lg">
                                                ...
                                                <input id="fname" type="text" class="form-control" placeholder="Enter Program Name here" name="name" value="" required="">
                                            ...
                                            <div class="col-md-4 col-lg">
                                                ...
                                                <input id="fname" type="text" class="form-control" placeholder="Enter Mobile here" name="contact" required="" minlength="10" maxlength="10" onkeypress="return isNumberKey(event)">
                                            ...
                                            <div class="col-md-4 col-lg">
                                                ...
                                                <input id="fname" type="email" class="form-control" placeholder="Enter Email here" name="email" required="" value="" >
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-4 col-lg">
                                                ...
                                                <input id="fname" type="password" class="form-control" placeholder="Enter Password here" name="password" minlength="6" value="" required="" >
