...
{{ App\Models\
    ...
    <title>{{ App\Models\tblSystemSettigs::systemname('systemname') }} | Designation Management</title>
...
<body class="layout-default">
                ...
                <div class="mdk-drawer-layout__content page">
                    ...
                    <div class="container-fluid page__heading-container">
                        ...
                        <div class="page__heading d-flex align-items-center justify-content-between">
                            ...
                            <h4 class="m-0">New Designation</h4>



                            <a href="{{ url('/designation') }}"><button type="button" class="btn btn-warning"><i class="fa fa-step-backward"></i>&nbsp;Back</button></a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                  ...
                                  <form action="{{ url('/post-designation') }}" id="form_sample_1" method="post" enctype="multipart/form-data" >
                                    ...
                                    <div class="card-form__body card-body">
                                        ...
                                        <div class="form-group row" id="chpater-row{{$k}}" @if($k != '1') style="display: none;" @endif>
                                            ...
                                            <div class="col-md-12 col-lg">
                                                ...
                                                <input id="designation{{ $k }}" type="text" class="form-control" placeholder="Enter Designation here" name="designation{{ $k }}">
    ...
    <script type="text/javascript">
...

        {
            ...
            document.getElementById('designation'+x).value = '';
