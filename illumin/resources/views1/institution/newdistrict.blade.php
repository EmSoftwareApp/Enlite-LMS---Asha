...
<body class="layout-default">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                  ...
                                  <form action="{{ url('/post-district') }}" id="form_sample_1" method="post" enctype="multipart/form-data" >
                                    ...
                                    <div class="card-form__body card-body">
                                        ...
                                        <div class="form-group row" id="chpater-row{{$k}}" @if($k != '1') style="display: none;" @endif>
                                            ...
                                            <div class="col-md-4 col-lg">
                                                ...
                                                <select  id="state{{ $k }}" class="form-control select2" name="state{{ $k }}">
                                            ...
                                            <div class="col-md-4 col-lg">
                                                ...
                                                <input id="district{{ $k }}" type="text" class="form-control" placeholder="Enter District Name here" name="district{{ $k }}">
    ...
    <script type="text/javascript">
...

        {
            ...
            document.getElementById('district'+x).value = '';
