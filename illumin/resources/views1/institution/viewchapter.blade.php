                ...
                <div class="mdk-drawer-layout__content page">
                    ...
                    <div class="container-fluid page__heading-container">
                        ...
                        <div class="page__heading d-flex align-items-center justify-content-between">
                            ...
                            <h4 class="m-0">View Chapter</h4>



                            <a href="{{ url('/chapter-management') }}"><button type="button" class="btn btn-primary btn-sm"><i class="fa fa-arrow-left"></i>&nbsp;Back</button></a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                  ...
                                  <form action="{{ url('/update-chapter') }}" id="form_sample_1" method="post" enctype="multipart/form-data" >
                                    ...
                                    <div class="card-form__body card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-4 col-lg">
                                                ...
                                                <select class="form-control" name="course" required="" onChange="ajxclevel2find(this.value);">

                                                    <option value="">Choose Course</option>

                                                    @foreach($course as $courses)

                                                     <option value="{{ $courses->id }}" @if($courses->id == $object->course) selected="selected" @endif>{{ $courses->coursename }}</option>
                                            ...
                                            <div class="col-md-4 col-lg">
                                                ...
                                                <select class="form-control" name="topic" required="" id="topic">
                                            ...
                                            <div class="col-md-4 col-lg">
                                                ...
                                                <input id="fname" type="text" class="form-control" placeholder="Enter Chapter Name here" name="chaptername" value="{{ $object->chaptername }}" required="">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12 col-lg">
                                                ...
                                                <textarea class="form-control" placeholder="Enter Description here" name="description">{{ $object->description }}</textarea>
