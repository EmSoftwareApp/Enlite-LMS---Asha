...
<head>
    ...
    <title>{{ App\Models\tblSystemSettigs::systemname('systemname') }} | Notification Management</title>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                  ...
                                  <form action="{{ url('/post-notification') }}" id="form_sample_1" method="post" enctype="multipart/form-data" >
...
<input id="" type="text" name="title" class="form-control"  placeholder="Title" value="">
                                            ...
                                            <div class="col-md-4 col-lg">
                                                ...
                                                <input id="" type="text" name="till_date" class="form-control"  placeholder="Enter Notify Till Date here" data-toggle="flatpickr" value="">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12 col-lg">
                                                ...
                                                <textarea class="form-control" placeholder="Enter Message here" name="message" rows="5" cols="80" ></textarea>
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <input type="submit" class="btn btn-success" value="Save Notification"/>
