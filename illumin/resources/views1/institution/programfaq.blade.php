...
<head>
    ...
    <style type="text/css">
        ...
        .modal-backdrop {
            ...
            position: initial !important;{{ App\Models\
                ...
                <div class="mdk-drawer-layout__content page">
                    ...
                    <div class="container-fluid page__heading-container">
                        ...
                        <div class="page__heading d-flex align-items-center justify-content-between">
                            ...
                            <a href="{{ url('/new-faq/'.$programid) }}"><button type="button" class="btn btn-warning"><i class="fa fa-step-forward"></i>&nbsp;New FAQ</button></a>
                                ...
                                <div class="col-lg-12 card-form__body">
                                    ...
                                    <div class="table-responsive border-bottom" data-toggle="lists" data-lists-values='["js-lists-values-employee-name"]'>
                                        ...
                                        <div class="container">
                                            ...
                                            <h6>Program : {{ App\Models\tblBasicSettings::programfind($programid) }}</h6>
                                                ...
                                                <table id="example" class="display" style="width:100%">
                                                    ...
                                                    <thead>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th style="width: 35%;">FAQ Question</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="center">
                                                                ...
                                                                <a href="{{ url('view-faq/'.$object->id) }}" class="text-muted">

                                                                    <i class="fa fa-edit"></i>

                                                                </a>

                                                                <a href="{{ url('faq-remove/'.$object->id) }}" class="text-muted" onclick="return confirm('Are you sure to Delete??');">
        ...
        if (checkBox.checked == true){
...

            {
                ...
                $.ajax({
                    ...
                    url: "<?php echo route('program-faq-approve') ?>",
...

            {
                ...
                $.ajax({
                    ...
                    url: "<?php echo route('program-faq-reject') ?>",
