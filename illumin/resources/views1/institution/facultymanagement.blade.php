                ...
                <div class="mdk-drawer-layout__content page">
                    ...
                    <div class="container-fluid page__heading-container">
                        ...
                        <div class="page__heading d-flex align-items-center justify-content-between">
                            ...
                            <h4 class="m-0">Faculty Management</h4>



                            <a href="{{ url('/new-faculty') }}">

                                <!--<button type="button" class="btn btn-primary btn-sm">New Program</button>-->

                                <button type="button" class="btn btn-warning">

                                    <i class="fa fa-paper-plane"></i> New Faculty
                                                ...
                                                <table id="example" class="display" style="width:100%">
                                                    ...
                                                    <thead>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th style="width: 15%; text-align: center;">Qualification</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="center">
                                                                ...
                                                                <a href="{{ url('view-faculty/'.$object->id) }}" class="text-muted">

                                                                    <i class="fa fa-edit"></i>

                                                                </a>

                                                                <a href="{{ url('faculty-remove/'.$object->id) }}" class="text-muted" onClick="return confirm('Are you sure to Delete??');">
        ...
        if (checkBox.checked == true){
...

            {
                ...
                $.ajax({
                    ...
                    url: "<?php echo route('faculty-approve') ?>",
...

            {
                ...
                $.ajax({
                    ...
                    url: "<?php echo route('faculty-reject') ?>",
