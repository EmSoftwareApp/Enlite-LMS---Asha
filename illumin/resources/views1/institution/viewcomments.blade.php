...
<head>
    ...
    <title>{{ App\Models\tblSystemSettigs::systemname('systemname') }} | View Comments</title>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="px-3">
                        ...
                        <input type="hidden" name="video_id" id="video_id" value="{{$object1->video_id}}">
                          <input type="hidden" name="course_id" id="course_id" value="{{$object1->course_id}}">
                          <input type="hidden" name="user_id" id="user_id" value="23">
                          <input type="hidden" name="userid" id="userid" value="{{$object1->user_id}}">
                            <div class="form-group">
                                <label for="email_2">Comment:</label>
                                <textarea class="form-control" id="comments" name="comments" required="" placeholder="Enter Reply here..."></textarea>
                            </div>
                ...
                <div class="mdk-drawer-layout__content page">
                    ...
                    <div class="container-fluid page__heading-container">
                        ...
                        <div class="page__heading d-flex align-items-center justify-content-between">
                            ...
                            <h4 class="m-0">Comments Management</h4>
                                                ...
                                                <table id="example" class="display" style="width:100%">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="media align-items-center">
                                                                    ...
                                                                    <div class="media-body">
                                                                        ...
                                                                        <span class="js-lists-values-employee-name">{{  $object->comments  }}</span>
                                                           ...
                                                           @if($object->user_id!='23')   <a href="#" class="openModal" data-toggle="modal" data-id="{{$object->cid}}" data-target="#modal-login"> <i data-v-da9425c4="" class="material-icons icon-40pt">reply</i></a>   @endif                                                        </td>
