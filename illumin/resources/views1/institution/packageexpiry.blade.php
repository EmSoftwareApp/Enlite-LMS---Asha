...
<head>
    ...
    <title>{{ App\Models\tblSystemSettigs::systemname('systemname') }} | Package Expiry List</title>
                ...
                <div class="mdk-drawer-layout__content page">
                    ...
                    <div class="container-fluid page__heading-container">
                        ...
                        <div class="page__heading d-flex align-items-center justify-content-between">
                            ...
                            <h4 class="m-0">Package Expiry List</h4>
  ...
  $(function () {
...

    {
...

        {
            ...
            window.location.href=cur_url+'/package-expiry-find/'+x;
