                ...
                <div class="mdk-drawer-layout__content page">
                    ...
                    <div class="container-fluid page__heading-container">
                        ...
                        <div class="page__heading d-flex align-items-center justify-content-between">
                            ...
                            <h4 class="m-0">Course App Settings</h4>
                                    ...
                                    <div class="table-responsive border-bottom" data-toggle="lists" data-lists-values='["js-lists-values-employee-name"]'>
                                        ...
                                        <div class="container">
                                            ...
                                            <section>
                                                ...
                                                <table id="example" class="display" style="width:100%">
                                                    ...
                                                    <thead>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th style="width: 20%;">App Image</th>

                                                            <th style="width: 15%;">App Inner Image</th>
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="media align-items-center">
                                                                    ...
                                                                    <div class="media-body">
                                                                        ...
                                                                        <span class="js-lists-values-employee-name">{{ $object->coursename }}</span>
                                                ...
                                                <img src="<?php echo asset($img_sg); ?>" alt="" style="width: 120px; height: 50px;">@endif
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="custom-control custom-checkbox">
                                                                    ...
                                                                    @if($object->image_lg != '')
						                                                ...
						                                                <img src="<?php echo asset($img_lg); ?>" alt="" style="width: 120px; height: 50px;">
                                                            ...
                                                            <td align="center">
                                                                ...
                                                                <a href="{{ url('view-app-course/'.$object->id) }}" class="text-muted">
        ...
        if (checkBox.checked == true){
...

            {
                ...
                $.ajax({
                    ...
                    url: "<?php echo route('course-approve') ?>",
...

            {
                ...
                $.ajax({
                    ...
                    url: "<?php echo route('course-reject') ?>",
