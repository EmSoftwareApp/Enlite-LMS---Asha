...
<head>
    ...
    <title>{{ App\Models\tblSystemSettigs::systemname('systemname') }} | Subject Management</title>
...
<body class="layout-default">
                ...
                <div class="mdk-drawer-layout__content page">
                    ...
                    <div class="container-fluid page__heading-container">
                        ...
                        <div class="page__heading d-flex align-items-center justify-content-between">
                            ...
                            <h4 class="m-0">New Subject</h4>



                            <a href="{{ url('/subject') }}"><button type="button" class="btn btn-warning"><i class="fa fa-step-backward"></i>&nbsp;Back</button></a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                  ...
                                  <form action="{{ url('/post-subject') }}" id="form_sample_1" method="post" enctype="multipart/form-data" >
                                  ...
                                  {{ csrf_field() }}
                                    ...
                                    <div class="card-form__body card-body">
                                        ...
                                        <div class="form-group row" id="chpater-row{{$k}}" @if($k != '1') style="display: none;" @endif>
                                            ...
                                            <div class="col-md-12 col-lg">
                                                ...
                                                <input id="subject{{ $k }}" type="text" class="form-control" placeholder="Enter Subject here" name="subject{{ $k }}">
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <input type="submit" class="btn btn-success" value="Save Subject"/>
    ...
    <script type="text/javascript">
...

        {
            ...
            document.getElementById('subject'+x).value = '';
