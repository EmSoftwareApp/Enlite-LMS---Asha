                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="center">
                                                                ...
                                                                <a href="{{ url('view-coordinator/'.$object->id) }}" class="text-muted">

                                                                    <i class="fa fa-edit"></i>

                                                                </a>

                                                                <a href="{{ url('coordinator-remove/'.$object->id) }}" class="text-muted" onClick="return confirm('Are you sure to Delete??');">
