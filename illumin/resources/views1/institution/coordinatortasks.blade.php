 ...
 <td >
                                                               ...
                                                               <div class="media align-items-center">
                                                                    ...
                                                                    <div class="media-body">
                                                                        ...
                                                                        <span class="js-lists-values-employee-name"><select onChange="set_status(this.value,{{$object->writing_id}})" name="faculty">@foreach($faculties as $faculty) 
                                                                       <option value="">Select Faculty</option> <option @if($object->faculty_id == $faculty->id) selected="selected" @endif value="{{$faculty->id}}">{{$faculty->fname}}</option>@endforeach</select></span>
                                                             ...
                                                             <div class="media align-items-center">
                                                                    ...
                                                                    <div class="media-body">
                                                                        ...
                                                                        <span class="js-lists-values-employee-name">@if($object->faculty_id!=0){{ App\Models\tblBasicSettings::facultyfind($object->faculty_id) }}@endif</span>
                                                             ...
                                                             <td >
                                                               ...
                                                               <div class="media align-items-center">
                                                                    ...
                                                                    <div class="media-body">
 {{ csrf_field() }}
                                                                        <span class="js-lists-values-employee-name">@if($object->wstatus=='0' || $object->wstatus=='3')<a title="accept" class="btn btn-dark btn-xs" href="{{ url('/accept-wprogram/'.$object->writing_id) }}"><button class="btn btn-default" style="padding: 2px;
    width: 25px;"><i class="fa fa-check-circle"></i></button></a>&nbsp;<a class="btn btn-dark btn-xs" title="reject" href="#" data-id="{{$object->writing_id}}" data-toggle="modal" data-target="#uploadModal"><button class="btn btn-default" style="padding: 2px;
