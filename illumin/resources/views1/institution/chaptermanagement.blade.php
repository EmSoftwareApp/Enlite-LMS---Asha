            ...
            <div class="mdk-drawer-layout js-mdk-drawer-layout" data-push data-responsive-width="992px">
                ...
                <div class="mdk-drawer-layout__content page">
                    ...
                    <div class="container-fluid page__heading-container">
                        ...
                        <div class="page__heading d-flex align-items-center justify-content-between">                         <h4 class="m-0">Chapter Management</h4>



                            <a href="{{ url('/new-chapter') }}">

                                <!--<button type="button" class="btn btn-primary btn-sm">New Chapter</button>-->

                                <button type="button" class="btn btn-warning">

                                    <i class="fa fa-paper-plane"></i> New Chapter
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="media align-items-center">
                                                                    ...
                                                                    <div class="media-body">
                                                                        ...
                                                                        <span class="js-lists-values-employee-name">{{ $object->chaptername }}</span>
                                                            ...
                                                            <td align="center">
                                                                ...
                                                                <a href="{{ url('view-chapter/'.$object->id) }}" class="text-muted">

                                                                    <i class="fa fa-edit"></i>

                                                                </a>

                                                                <a href="{{ url('chapter-remove/'.$object->id) }}" class="text-muted" onclick="return confirm('Are you sure to Delete??');">
        ...
        if (checkBox.checked == true){
...

            {
                ...
                $.ajax({
                    ...
                    url: "<?php echo route('chapter-approve') ?>",
...

            {
                ...
                $.ajax({
                    ...
                    url: "<?php echo route('chapter-reject') ?>",
