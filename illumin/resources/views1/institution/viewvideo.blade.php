                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                  ...
                                  <form action="{{ url('/update-video') }}" id="form_sample_1" method="post" enctype="multipart/form-data" onSubmit="return validateForm()" >
                                    ...
                                    <div class="card-form__body card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-4 col-lg">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter Video Link/URL here" name="url" value="{{ $object->url }}" required="">
                                            ...
                                            <div class="col-md-4 col-lg">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter Video Caption here" name="videocaption" value="{{ $object->videocaption }}" required="">
                                            ...
                                            <div class="col-md-4 col-lg">
                                                ...
                                                <select class="form-control" name="language" id="language" >
                                                    ...
                                                    <option value="" @if($object->language == '') selected="selected" @endif>Choose language</option>

                                                    <option value="1" @if($object->language == '1') selected="selected" @endif>English</option>

                                                    <option value="2" @if($object->language == '2') selected="selected" @endif>Malayalam</option>

                                                    <option value="3" @if($object->language == '3') selected="selected" @endif>Hindi</option>
...
<div class="form-group row">
                                            ...
                                            <div class="col-md-4 col-lg">
                                                ...
                                                <label for="fname">Video Duration</label>

                                                <input type="text" class="form-control" placeholder="Enter Minutes(Eg:00)" name="duration_min" value="{{ $object->duration_min }}" required="">
                                                </div> <div class="col-md-4 col-lg">
                                                 <label for="fname"></label>
                                                <input type="text" class="form-control" placeholder="Enter Seconds(Eg:00)" name="duration_sec" value="{{ $object->duration_sec }}" required="">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12 col-lg">
                                                ...
                                                <label for="fname">Description</label>
                                                 ...
                                                 <textarea id="editor1" name="description" rows="10" cols="80" placeholder="Video Description Added Here..">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-3 col-lg">
                                                ...
                                                <label for="fname">Study Material</label>
                                            ...
                                            <div class="col-md-3 col-lg">
                                                ...
                                                <label for="fname">Previous Study Material</label>

                                                <div class="clearfix"></div>

                                                <a href="{{ url('/'.$object->uploads) }}" target="_blank"><button type="button" class="btn btn-warning btn-sm"><i class="fa fa-download"></i>&nbsp;Download</button></a>

                                                <a href="{{ url('/remove-video-assignment/'.$object->id) }}" onClick="return confirm('Are you sure to remove this download?');">
                                            ...
                                            <div class="col-md-3 col-lg">
                                                ...
                                                <label for="fname">Downloads</label>
                                            ...
                                            <div class="col-md-3 col-lg">
                                                ...
                                                <label for="fname">Previous Downloads</label>

                                                <div class="clearfix"></div>

                                                <a href="{{ url('/'.$object->downloads) }}" target="_blank"><button type="button" class="btn btn-warning btn-sm"><i class="fa fa-download"></i>&nbsp;Downlod</button></a>

                                                <a href="{{ url('/remove-video-download/'.$object->id) }}" onClick="return confirm('Are you sure to remove this download?');">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6 col-lg">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter Meta Title here" name="metatitle" value="{{ $object->metatitle }}">
                                            ...
                                            <div class="col-md-6 col-lg">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter Keywords here" name="keywords" value="{{ $object->keywords }}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12 col-lg">
                                                ...
                                                <textarea class="form-control" placeholder="Enter Meta Description here" name="metadescription">{{ $object->metadescription }}</textarea>
                                        ...
                                        <input type="hidden" name="primage" value="{{ $object->uploads }}">

                                        <input type="hidden" name="prdownload" value="{{ $object->downloads }}">

                                        <input type="hidden" name="thumb_url" value="{{ $object->thumb_url }}">
