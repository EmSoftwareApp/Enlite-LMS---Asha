                    ...
                    <div class="col-md-9">
                        ...
                        <div class="row">
                            ...
                            <?php
                                ...
                                $time = App\tblProgram::programfinder($object->prgrmid, 'id', 'regtime');
                                ...
                                <div class="card card__course">
                                    ...
                                    <div class="card-header card-header-large card-header-dark bg-dark d-flex justify-content-center">
                                        ...
                                        <a class="card-header__title  justify-content-center align-self-center d-flex flex-column" href="{{ url('/course-enroll/'.$time) }}">
                                            ...
                                            <span class="course__subtitle">{{ App\tblProgram::programfinder($object->prgrmid, 'id', 'programname') }}</span>
                                    ...
                                    <div class="p-3">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <strong class="h5 m-0">₹ {{ App\tblProgram::programfinder($object->prgrmid, 'id', 'amount') }}</strong>
                            ...
                            <?php
                                ...
                                $batchenddate = App\tblProgram::batchendate($batches->batchid, $userid);
                            ...
                            @if($batchenddate >= $today)
                             ...
                             <?php
                                ...
                                foreach ($agents1 as $agent1) { 
                                    ...
                                    $time = App\tblProgram::programfinder($agent1->program, 'id', 'regtime');

                                    $progmcount =  App\tblProgram::multiprogramfinder($userid, $agent1->program);
                                ...
                                <div class="card card__course">
                                    ...
                                    <div class="card-header card-header-large card-header-dark bg-dark d-flex justify-content-center">
                                        ...
                                        <a class="card-header__title  justify-content-center align-self-center d-flex flex-column" href="{{ url('/course-enroll/'.$time) }}">
                                            ...
                                            <span class="course__subtitle">{{ App\tblProgram::programfinder($agent1->program, 'id', 'programname') }}</span>
                                    ...
                                    <div class="p-3">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <strong class="h4 m-0">₹ {{ App\tblProgram::programfinder($agent1->program, 'id', 'amount') }}</strong>
