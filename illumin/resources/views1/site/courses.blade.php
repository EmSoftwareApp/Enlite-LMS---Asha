<?php $cour_param = Request::segment(1); ?>
            ...
            <div class="container page__container">
                ...
                <div class="card clear-shadow">
                    ...
                    <div class="bg-soft-light-gray card-header card-header-tabs-basic nav" role="tablist">
                        ...
                        <!--<a href="{{ url('/courses') }}" @if($cour_param == 'courses') class="active" @endif>All</a>-->

                        <a href="{{ url('/video-courses') }}" @if($cour_param == 'video-courses') class="active" @endif >Video Courses</a>

                        <a href="{{ url('/test-courses') }}" @if($cour_param == 'test-courses') class="active" @endif >Test Courses</a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4">
                            ...
                            <div class="card card__course card__course__animate" style="width:350px;">
                                ...
                                @if($cour_param == 'test-courses')

                                <a href="{{ url('/test-course-details/'.$object->id) }}" class="card-img-top">
                                ...
                                <div class="p-3 text-center border-bottom">
                                    ...
                                    <div class="bold mb-2">
                                        ...
                                        <a href="{{ url('/test-course-details/'.$object->id) }}" class="text-body">
