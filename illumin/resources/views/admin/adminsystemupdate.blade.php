...
<div class="col-md-12 col-lg">
    ...
    <textarea id="emailcontent" rows="4" class="form-control" placeholder="Please enter an Email Content" name="emailcontent">{{ $object->emailcontent }}</textarea>
...
<div class="col-md-12 col-lg">
    ...
    <textarea id="smscontent" rows="4" class="form-control" placeholder="Please enter a SMS Content" name="smscontent">{{ $object->smscontent }}</textarea>
