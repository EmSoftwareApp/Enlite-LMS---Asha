...
<head>
    ...
    <title>{{ App\Models\tblSystemSettigs::systemname('systemname') }} Admin | Login</title>
            ...
            <form action="{{url('/adminsignin')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group input-group-merge">
                        <input id="email_2" type="text" required="" class="form-control form-control-prepended" placeholder="Username" name="username">
