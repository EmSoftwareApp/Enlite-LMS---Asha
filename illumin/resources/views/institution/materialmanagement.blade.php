                ...
                <div class="mdk-drawer-layout__content page">
                    ...
                    <div class="container-fluid page__heading-container">
                        ...
                        <div class="page__heading d-flex align-items-center justify-content-between">
                            ...
                            <h4 class="m-0">Material Management</h4>



                            <!--<button type="button" class="btn btn-success btn-sm" style=" padding: 0.5rem 1.5rem;">New Material</button>-->



                            <a href="{{ url('/new-material') }}">

                                <button type="button" class="btn btn-warning">

                                    <i class="fa fa-paper-plane"></i> New Material
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="year" onChange="pgmselect(this.value);">
                                                            ...
                                                            <option value="" @if($pgmserch == '') selected="selected" @endif> Choose Course</option>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="media align-items-center">
                                                                    ...
                                                                    <div class="media-body">
                                                                        ...
                                                                        <span class="js-lists-values-employee-name">{{ $object->materialcaption }}</span>
                                                            ...
                                                            <td align="center">
                                                                ...
                                                                <a href="{{ url('view-material/'.$object->id) }}" class="text-muted">

                                                                    <i class="fa fa-edit"></i>

                                                                </a>

                                                                <a href="{{ url('material-remove/'.$object->id) }}" class="text-muted" onClick="return confirm('Are you sure to Delete??');">
...
<script>
        ...
        if (checkBox.checked == true){
...

            {
                ...
                $.ajax({
                    ...
                    url: "<?php echo route('material-approve') ?>",
...

            {
                ...
                $.ajax({
                    ...
                    url: "<?php echo route('material-reject') ?>",
...

    {
...

        {
            ...
            window.location.href=cur_url+'/material-management-find/'+x;
