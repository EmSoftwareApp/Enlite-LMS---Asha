                ...
                <div class="mdk-drawer-layout__content page">
                    ...
                    <div class="container-fluid page__heading-container">
                        <div class="page__heading d-flex align-items-center justify-content-between">
                            <h4 class="m-0">View Feed Category</h4>
                    ...
                    <div class="container-fluid page__container">
                        <div class="row no-gutters">
                            <div class="col-md-12">
                                <div class="card">
                                  <form action="{{ url('/update-feedcategory') }}" id="form_sample_1" method="post" enctype="multipart/form-data" >
                                  {{ csrf_field() }}
                                    <div class="card-form__body card-body">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-11">
                                                <label for="fname">Edit feed Category</label>
                                                <input id="fname" type="text" class="form-control" placeholder="Enter new event category" name="category" value="{{ $object->category }}"   required="">
