                ...
                <div class="mdk-drawer-layout__content page">
                    ...
                    <div class="container-fluid page__container">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                  <form action="{{ url('/update-course') }}" id="form_sample_1" method="post" enctype="multipart/form-data" >
                                  {{ csrf_field() }}
                                    <div class="card-form__body card-body">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6 col-lg">
                                                ...
                                                <input id="fname" type="text" class="form-control" placeholder="Enter Course Name here" name="coursename" value="{{ $object->coursename }}" required="">
                                            </div>
                                            <div class="col-md-6 col-lg">
                                                <label for="fname">Course Short Name</label>
                                                <input id="fname" type="text" class="form-control" placeholder="Enter Course Short Name here" name="courseshortname" value="{{ $object->courseshortname }}" >
                                            </div>
                                        </div>
