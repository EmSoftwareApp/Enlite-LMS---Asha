                ...
                <div class="mdk-drawer-layout__content page">
                    ...
                    <div class="container-fluid page__container">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                  <form action="{{ url('/update-staff') }}" id="form_sample_1" method="post" enctype="multipart/form-data" >
                                  {{ csrf_field() }}
                                    <div class="card-form__body card-body">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-4 col-lg">
                                                ...
                                                <input id="fname" type="text" class="form-control" placeholder="Enter Program Name here" name="name" value="{{ $object->name }}" required="">
                                            </div>
                                            <div class="col-md-4 col-lg">
                                                <label for="fname">Mobile*</label>
                                                <input id="fname" type="text" class="form-control" placeholder="Enter Mobile here" name="contact" value="{{ $object->contact }}" required="" minlength="10" maxlength="10" onkeypress="return isNumberKey(event)" >
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-4 col-lg">
                                                ...
                                                <input id="fname" type="password" class="form-control" placeholder="Enter Password here" name="" minlength="6" value="Password" readonly="" disabled="" >
                                            </div>
                                            <div class="col-md-4 col-lg">
                                                ...
                                                <select class="form-control" name="position" required="">
                                                    ...
                                                    @foreach($desig as $desigs)
                                                     <option value="{{ $desigs->id }}" @if($desigs->id == $object->position) selected="selected" @endif>{{ $desigs->designation }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-md-4 col-lg">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-4 col-lg">
                                                <label for="fname">Staff Image (350px * 200px)</label>
                                                <div class="clearfix"></div>
                                            ...
                                            <div class="col-md-4 col-lg">
                                                ...
                                                <label for="fname">Previous Staff Image</label>
                                                <div class="clearfix"></div>
                                                <img src="<?php echo asset($img); ?>" width="120" height="70">
                                                <a href="{{ url('/remove-staff-image/'.$object->id) }}" onclick="return confirm('Are you sure to remove this Image?');">
