                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="media align-items-center">
                                                                    ...
                                                                    <div class="media-body">
                                                                        ...
                                                                        <span class="js-lists-values-employee-name">{{ $object->subject }}</span>
                                                            ...
                                                            <td align="center">
                                                                ...
                                                                <a href="{{ url('view-subject/'.$object->id) }}" class="text-muted">

                                                                    <i class="fa fa-edit"></i>

                                                                </a>

                                                                <a href="{{ url('subject-remove/'.$object->id) }}" class="text-muted" onClick="return confirm('Are you sure to Delete??');">
        ...
        if (checkBox.checked == true){
...

            {
                ...
                $.ajax({
                    ...
                    url: "<?php echo route('subject-approve') ?>",
...

            {
                ...
                $.ajax({
                    ...
                    url: "<?php echo route('subject-reject') ?>",
