@foreach($languagesar as $languagesar)
@endforeach
...
<head>
    ...
    <title>{{ App\Models\tblSystemSettigs::systemname('systemname') }} |Labels Management</title>
                ...
                <div class="mdk-drawer-layout__content page">
                    ...
                    <div class="container-fluid page__heading-container">
                        <div class="page__heading d-flex align-items-center justify-content-between">
                            <h4 class="m-0">Edit Labels</h4>

                            <a href="{{ url('/labels') }}"><button type="button" class="btn btn-warning"><i class="fa fa-step-backward"></i>&nbsp;Back</button></a>
                        </div>
                    </div>
                    ...
                    <div class="container-fluid page__container">
                        <div class="row">
                            <div class="col-md-11">
                                <div class="card">
                                  <form action="{{ url('/update-labels') }}" id="form_sample_1" method="post" enctype="multipart/form-data" >
                                  {{ csrf_field() }}
                                    <div class="card-form__body card-body">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-11">
                                                ...
                                                <input id="fname" type="text" class="form-control" placeholder="Enter Label Here" name="labels"  value="{{ $languagesar->labels }}"  required="">
                                        ...
                                        <input type="hidden" name="lanid" value="{{ $languagesar->id }}">
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <input type="submit" class="btn btn-success" value="Save Labels "/>
                                    </div>
                                  </form>
                                </div>
                            </div>
