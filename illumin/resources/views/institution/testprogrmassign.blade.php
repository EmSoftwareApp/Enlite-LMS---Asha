                ...
                <div class="mdk-drawer-layout__content page">
                    ...
                    <div class="container-fluid page__heading-container">
                        <div class="page__heading d-flex align-items-center justify-content-between">
                            <h4 class="m-0">Test Program Management</h4>
                                    ...
                                    <div class="card-form__body card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-4 col-lg">
                                                ...
                                                <input id="topicname" type="text" class="form-control" name="topicname" value="{{ App\Models\tblBasicSettings::testfind($test) }}" disabled="">
                                            </div>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="media align-items-center">
                                                                    <div class="media-body">
                                                                        <span class="js-lists-values-employee-name">{{ App\Models\tblBasicSettings::testfind($pgmtests->test) }}</span>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <div class="media align-items-center">
                                                                    <div class="media-body">
                                                                        <span class="js-lists-values-employee-name">{{ App\Models\tblBasicSettings::programfind($pgmtests->program) }}</span>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td align="center">
                                                                ...
                                                                <a href="{{ url('test-program-remove/'.$pgmtests->id) }}" class="text-muted" onclick="return confirm('Are you sure to Delete??');">
