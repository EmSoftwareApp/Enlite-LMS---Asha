                ...
                <div class="mdk-drawer-layout__content page">
                    ...
                    <div class="container-fluid page__heading-container">
                        <div class="page__heading d-flex align-items-center justify-content-between">
                            <h4 class="m-0">Instructor Management</h4>

                            <a href="{{ url('/new-instructor') }}">
                                <!--<button type="button" class="btn btn-primary btn-sm">New Program</button>-->
                                <button type="button" class="btn btn-warning">
                                    <i class="fa fa-paper-plane"></i> New Instructor
                                </button>
                            </a>
                        </div>
                    </div>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="media align-items-center">
                                                                    <div class="media-body">
                                                                        <span class="js-lists-values-employee-name">{{ $object->instructorname }}</span>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <div class="media align-items-center">
                                                                    <div class="media-body">
                                                                        <span class="js-lists-values-employee-name">{{ $object->empcode }}</span>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td align="center">
                                                                <?php if($object->image != ''){
                                                                $img = $object->image; ?>
                                                                <img src="<?php echo asset($img); ?>" alt="" style="border-radius: 50%; width: 60px; height: 60px;">
                                                                <?php  } ?>
                                                            ...
                                                            <td align="center">
                                                                <a href="{{ url('view-instructor/'.$object->id) }}" class="text-muted">
                                                                    <i class="fa fa-edit"></i>
                                                                </a>
                                                                <a href="{{ url('instructor-remove/'.$object->id) }}" class="text-muted" onclick="return confirm('Are you sure to Delete??');">
        ...
        if (checkBox.checked == true){
            if(db_id != '')
            {
                $.ajax({
                    ...
                    url: "<?php echo route('ins-approve') ?>",
                    method: 'POST',
