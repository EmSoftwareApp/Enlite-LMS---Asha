...
<head>
    ...
    <title>{{ App\Models\tblSystemSettigs::systemname('systemname') }} |News Category Management</title>
                ...
                <div class="mdk-drawer-layout__content page">
                    ...
                    <div class="container-fluid page__heading-container">
                        <div class="page__heading d-flex align-items-center justify-content-between">
                            ...
                            <a href="{{ url('/newscategory') }}"><button type="button" class="btn btn-warning"><i class="fa fa-step-backward"></i>&nbsp;Back</button></a>
                        </div>
                    </div>
                    ...
                    <div class="container-fluid page__container">
                        <div class="row">
                            <div class="col-md-11">
                                <div class="card">
                                  <form action="{{ url('/update-newscategory') }}" id="form_sample_1" method="post" enctype="multipart/form-data" >
                                  {{ csrf_field() }}
                                    <div class="card-form__body card-body">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-11">
                                                ...
                                                <input id="fname" type="text" class="form-control" placeholder="Enter Category Here" name="labels"  value="{{ $languagesar->category }}"  required="">
