...
<head>
    ...
    <title>{{ App\Models\tblSystemSettigs::systemname('systemname') }} | Upload Writing Program Question Paper</title>
                ...
                <div class="mdk-drawer-layout__content page">
                    ...
                    <div class="container-fluid page__heading-container">
                        <div class="page__heading d-flex align-items-center justify-content-between">
                            <h4 class="m-0">Upload New Question Paper</h4>
                    ...
                    <div class="container-fluid page__container">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                  <form action="{{ url('/post-wprogram') }}" id="form_sample_1" method="post" enctype="multipart/form-data" >
                                  {{ csrf_field() }}
                                    <div class="card-form__body card-body">
                                        @if(count($errors)>0)
                                          ...
                                          @endforeach
                                        @endif
                                        <h6>Writing Program Question Details</h6>
                                        <hr>
                                            ...
                                            <div class="col-md-4 col-lg">
                                                ...
                                                <select class="form-control" name="course" required="">
                                                    ...
                                                    @foreach($course as $courses)
                                                     <option value="{{ $courses->id }}">{{ $courses->programname }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-md-4 col-lg">
                                                <label for="fname">Title</label>
                                                <input id="fname" type="text" class="form-control" placeholder="Enter Title here" name="title" value="" required="">
                                            </div>
                                            <div class="col-md-4 col-lg">
                                                ...
                                                <select class="form-control" name="subject">
                                                    ...
                                                    @foreach($subject as $insts)
                                                     <option value="{{ $insts->id }}">{{ $insts->subject }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-4 col-lg">
                                                ...
                                                <div class="clearfix"></div>
                                        <input id="" type="text" class="form-control" placeholder="Enter Publish Date here" name="dop" data-toggle="flatpickr" value="" >
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-4 col-lg">
                                                ...
                                                <div class="clearfix"></div>
                                               <input id="" type="text" class="form-control" placeholder="Enter Publish Date here" name="dvalidfrom" data-toggle="flatpickr" value="" >
                                            ...
                                            <div class="col-md-4 col-lg">
                                                ...
                                                <div class="clearfix"></div>
                                        <input id="" type="text" class="form-control" placeholder="Enter Publish Date here" name="dvalidto" data-toggle="flatpickr" value="" >
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-4 col-lg">
                                                ...
                                                <div class="clearfix"></div>
                                               <input id="" type="text" class="form-control" placeholder="Enter Publish Date here" name="uvalidfrom" data-toggle="flatpickr" value="" >
                                            ...
                                            <div class="col-md-4 col-lg">
                                                <label for="fname">Valid To</label>
                                                <div class="clearfix"></div>
                                        <input id="" type="text" class="form-control" placeholder="Enter Publish Date here" name="uvalidto" data-toggle="flatpickr" value="" >
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-4 col-lg">
                                                <label for="fname">Date of Publish</label>
                                                <div class="clearfix"></div>
                                        <input id="" type="text" class="form-control" placeholder="Enter Publish Date here" name="adop" data-toggle="flatpickr" value="" >
                                        </div>
