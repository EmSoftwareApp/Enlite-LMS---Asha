...
<head>
    ...
    <title>{{ App\Models\tblSystemSettigs::systemname('systemname') }} | Qualification Management</title>
                ...
                <div class="mdk-drawer-layout__content page">
                    ...
                    <div class="container-fluid page__heading-container">
                        <div class="page__heading d-flex align-items-center justify-content-between">
                            <h4 class="m-0">Qualification Management</h4>

                            <a href="{{ url('/new-qualification') }}">
                                <!--<button type="button" class="btn btn-primary btn-sm">New Qualification</button>-->
                                <button type="button" class="btn btn-warning">
                                    <i class="fa fa-paper-plane"></i> New Qualification
                                </button>
                            </a>
                        </div>
                    </div>
                                                ...
                                                <table id="example" class="display" style="width:100%">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style="width: 70%;">Qualification</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="media align-items-center">
                                                                    <div class="media-body">
                                                                        <span class="js-lists-values-employee-name">{{ $object->qualification }}</span>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            ...
                                                            {{ csrf_field() }}
                                                            <td align="center">
                                                                <a href="{{ url('view-qualification/'.$object->id) }}" class="text-muted">
                                                                    <i class="fa fa-edit"></i>
                                                                </a>
                                                                <a href="{{ url('qualification-remove/'.$object->id) }}" class="text-muted" onclick="return confirm('Are you sure to Delete??');">
        ...
        if (checkBox.checked == true){
            if(db_id != '')
            {
                $.ajax({
                    ...
                    url: "<?php echo route('qualification-approve') ?>",
                    method: 'POST',
            ...
            if(db_id != '')
            {
                $.ajax({
                    ...
                    url: "<?php echo route('qualification-reject') ?>",
                    method: 'POST',
                    data: {db_id:db_id,  _token:token},
                    success: function(data) {
                        //alert(data);
