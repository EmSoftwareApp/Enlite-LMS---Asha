                ...
                <div class="mdk-drawer-layout__content page">
                    ...
                    <div class="container-fluid page__container">
                        <div class="row">
                            <div class="col-md-11">
                                <div class="card">
                                  <form action="{{ url('/post-labels') }}" id="form_sample_1" method="post" enctype="multipart/form-data" >
                                  {{ csrf_field() }}
                                    <div class="card-form__body card-body">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-11">
                                                ...
                                                <input id="fname" type="text" class="form-control" placeholder="Enter Label Here" name="labels"   required="">
