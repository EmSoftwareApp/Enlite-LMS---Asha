                ...
                <div class="mdk-drawer-layout__content page">
                    ...
                    <div class="container-fluid page__heading-container">
                        <div class="page__heading d-flex align-items-center justify-content-between">
                            <h4 class="m-0">Student Batch Management</h4>
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="year" onchange="yearselect();">
                                                            <option value="" @if($ser_year == '') selected="selected" @endif> Choose Academic Year</option>
                                                ...
                                                <table id="example" class="display" style="width:100%">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="center">
                                                                <a href="{{ url('student-assign-batch/'.$object->id) }}" class="text-muted" data-toggle="tooltip" title="Add Students to {{ $object->batchname }}">
                                                                    <i class="fa fa-user-tag"></i>
                                                                </a>
                                                            </td>
                                                            <td align="center">

<a href="{{ url('faculty-assign-batch/'.$object->id) }}" class="text-muted" >
...
<a href="{{ url('zoom-assign-batch/'.$object->id) }}" class="text-muted" >
    ...
    <i class="fa fa-video"></i>
                                                            ...
                                                            <td align="center">
                                                                <a href="{{ url('view-batch/'.$object->id) }}" class="text-muted">
                                                                    <i class="fa fa-edit"></i>
                                                                </a>
                                                                <a href="{{ url('batch-remove/'.$object->id) }}" class="text-muted" onclick="return confirm('Are you sure to Delete??');">
  ...
  $(function () {
    ...
    function yearselect()
    {
        ...
        if(x != '')
        {
            ...
            window.location.href=cur_url+'/student-batch-find/'+x;
        }
    }
</script>
<script>
        ...
        if (checkBox.checked == true){
            if(db_id != '')
            {
                $.ajax({
                    ...
                    url: "<?php echo route('batch-approve') ?>",
                    method: 'POST',
            ...
            if(db_id != '')
            {
                $.ajax({
                    ...
                    url: "<?php echo route('batch-reject') ?>",
                    method: 'POST',
                    data: {db_id:db_id,  _token:token},
                    success: function(data) {
                        //alert(data);
