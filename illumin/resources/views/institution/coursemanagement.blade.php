...
<head>
    ...
    <title>{{ App\Models\tblSystemSettigs::systemname('systemname') }} | Stream Management</title>
                                                ...
                                                <table id="example" class="display" style="width:100%">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style="width: 50%;">Stream Name</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="media align-items-center">
                                                                    <div class="media-body">
                                                                        <span class="js-lists-values-employee-name">{{ $object->courseshortname }}</span>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            {{ csrf_field() }}
                                                            ...
                                                            <td align="center">
                                                                <a href="{{ url('view-course/'.$object->id) }}" class="text-muted">
                                                                    <i class="fa fa-edit"></i>
                                                                </a>
                                                                <a href="{{ url('course-remove/'.$object->id) }}" class="text-muted" onclick="return confirm('Are you sure to Delete??');">
