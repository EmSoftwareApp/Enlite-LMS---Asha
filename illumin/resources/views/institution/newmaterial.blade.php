                        ...
                        <div class="row no-gutters">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                  ...
                                  <form action="{{ url('/post-material') }}" id="form_sample_1" method="post" enctype="multipart/form-data" onSubmit="return validateForm()">
...
@endforeach
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6 col-lg">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter material Caption here" name="materialcaption" value="" required="">
...
@endforeach
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <label for="fname">Description</label>
                                                 ...
                                                 <textarea id="editor1" name="description" rows="15" cols="115" placeholder="material Description Added Here..">
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <input type="submit" class="btn btn-success" value="Save Material"/>
