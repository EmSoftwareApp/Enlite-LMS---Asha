...
<head>
    ...
    <title>{{ App\Models\tblSystemSettigs::systemname('systemname') }} | District Management</title>
                ...
                <div class="mdk-drawer-layout__content page">
                    ...
                    <div class="container-fluid page__heading-container">
                        <div class="page__heading d-flex align-items-center justify-content-between">
                            <h4 class="m-0">Disrict Management</h4>

                            <a href="{{ url('/new-district') }}">
                                <!--<button type="button" class="btn btn-primary btn-sm">New Course</button>-->
                                <button type="button" class="btn btn-warning">
                                    <i class="fa fa-paper-plane"></i> New Disrict
                                </button>
                            </a>
                        </div>
                    </div>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="media align-items-center">
                                                                    <div class="media-body">
                                                                        <span class="js-lists-values-employee-name">{{ App\Models\tblBasicSettings::statefind($object->state)  }}</span>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="media align-items-center">
                                                                    <div class="media-body">
                                                                        <span class="js-lists-values-employee-name">{{ $object->district }}</span>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td>
                                                             ...
                                                             {{ csrf_field() }}
                                                            <td align="center">
                                                                <a href="{{ url('view-district/'.$object->id) }}" class="text-muted">
                                                                    <i class="fa fa-edit"></i>
                                                                </a>
                                                                <a href="{{ url('district-remove/'.$object->id) }}" class="text-muted" onclick="return confirm('Are you sure to Delete??');">
        ...
        if (checkBox.checked == true){
            if(db_id != '')
            {
                $.ajax({
                    ...
                    url: "<?php echo route('district-approve') ?>",
                    method: 'POST',
            ...
            if(db_id != '')
            {
                $.ajax({
                    ...
                    url: "<?php echo route('district-reject') ?>",
                    method: 'POST',
                    data: {db_id:db_id,  _token:token},
                    success: function(data) {
                        //alert(data);
