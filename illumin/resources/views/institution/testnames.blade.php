                                                ...
                                                <table id="example" class="display" style="width:100%">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style="width: 20%;">Assign Program</th>
                                                            <th style="width: 20%;">Assign Questions</th>
                                                            ...
                                                            <td>
                                                                <div class="media align-items-center">
                                                                    <div class="media-body">
                                                                        <span class="js-lists-values-employee-name">{{ $object->testname }}</span>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="media align-items-center">
                                                                    <div class="media-body">
                                                                        <span class="js-lists-values-employee-name">{{ $object->testshortname }}</span>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td style="text-align: center;">
                                                                <a href="{{ url('test-progrm-assign/'.$object->id) }}" data-toggle="tooltip" title="View Assigned Programs">
                                                                    <i class="fa fa-file-upload"></i>
                                                                </a>
                                                            </td>
                                                            <td align="center">
                                                                <a href="{{ url('/questions-assigned/'.$object->id) }}" style=" text-decoration: none;" data-toggle="tooltip" title="Assign Questions"><i class="fa fa-question"></i></a>
                                                            </td> 
                                                            <td>
                                                             ...
                                                             {{ csrf_field() }}
                                                            <td align="center">
                                                                <a href="{{ url('view-test-names/'.$object->id) }}" class="text-muted">
                                                                    <i class="fa fa-edit"></i>
                                                                </a>
                                                                <a href="{{ url('test-name-remove/'.$object->id) }}" class="text-muted" onclick="return confirm('Are you sure to Delete??');">
        ...
        if (checkBox.checked == true){
            if(db_id != '')
            {
                $.ajax({
                    ...
                    url: "<?php echo route('test-name-approve') ?>",
                    method: 'POST',
            ...
            if(db_id != '')
            {
                $.ajax({
                    ...
                    url: "<?php echo route('test-name-reject') ?>",
                    method: 'POST',
                    data: {db_id:db_id,  _token:token},
                    success: function(data) {
                        //alert(data);
