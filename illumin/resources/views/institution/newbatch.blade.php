                ...
                <div class="mdk-drawer-layout__content page">
                    ...
                    <div class="container-fluid page__heading-container">
                        <div class="page__heading d-flex align-items-center justify-content-between">
                            <h4 class="m-0">New Student Batch</h4>
                                    ...
                                    <div class="card-form__body card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-4 col-lg">
                                                ...
                                                <input id="fname" type="text" class="form-control" placeholder="Enter Batch Name here" name="batchname" value="" required="">
                                            </div>
                                            <div class="col-md-4 col-lg">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-4 col-lg">
                                                ...
                                                <input id="" type="text" class="form-control" placeholder="Enter Batch End Date here" name="batchend" data-toggle="flatpickr" value="" >
                                            </div>
                                            <div class="col-md-4 col-lg">
