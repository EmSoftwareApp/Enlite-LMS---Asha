                ...
                <div class="mdk-drawer-layout__content page">
                    ...
                    <div class="container-fluid page__heading-container">
                        <div class="page__heading d-flex align-items-center justify-content-between">
                            <h4 class="m-0">View Free Video</h4>
                    ...
                    <div class="container-fluid page__container">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                  <form action="{{ url('/update-freevideo') }}" id="form_sample_1" method="post" enctype="multipart/form-data" onSubmit="return validateForm()">
                                  {{ csrf_field() }}
                                    <div class="card-form__body card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-4 col-lg">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter Video Caption here" name="videocaption" value="{{ $object->videocaption }}">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-12 col-lg">
                                                <label for="fname">Description</label>
                                                 <textarea name="description" class="form-control" rows="7" cols="80" placeholder="Video Description Added Here..">{{ $object->description }}
