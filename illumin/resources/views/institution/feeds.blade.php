...
<th style="width: 5%;">Popular Feed</th> 
                                                            ...
                                                            <td>
                                                                <div class="media align-items-center">
                                                                    <div class="media-body">
                                                                        <span class="js-lists-values-employee-name">{{ App\Models\tblFeedCategory::feedcategory($object->category) }} </span>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td>
...
<div class="media align-items-center">
    ...
    <div class="media-body">
        ...
        <span class="js-lists-values-employee-name">
            ...
            $string = strip_tags($object->description );
...
<a href="" data-toggle="tooltip" title="{{ strip_tags( $object->description) }} ">Read More</a>    
...
<div class="media align-items-center">
    ...
    <div class="media-body">
        ...
        <span class="js-lists-values-employee-name">
            ...
            {{ date('d-m-Y', strtotime($object->pdate)) }}  
...
<td> 
                                                                ...
                                                                <div class="media align-items-center">
                                                                    ...
                                                                    <div class="media-body">
                                                                        ...
                                                                        <span class="js-lists-values-employee-name"><img src="/../{{ $object->tumbimage }}" width="50px" height="50px"></span>
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="custom-control custom-checkbox">
                                                                    ...
                                                                    <input type="checkbox" class="" style=" margin-top: 5px;" id="myChecki{{$i}}" onChange="popularevents({{ $i }}, {{ $object->id }})" @if($object->popularstatus == '1') checked="checked" @endif>
                                                             ...
                                                             {{ csrf_field() }}
                                                            <td align="center">
                                                                <a href="{{ url('view-feed/'.$object->id) }}" class="text-muted">
                                                                    <i class="fa fa-edit"></i>
                                                                </a>
                                                                <a href="{{ url('feed-remove/'.$object->id) }}" class="text-muted" onclick="return confirm('Are you sure to Delete??');">
        ...
        if (checkBox.checked == true){
            if(db_id != '')
            {
                $.ajax({
                    ...
                    url: "<?php echo route('feed-approve') ?>",
                    method: 'POST',
            ...
            if(db_id != '')
            {
                $.ajax({
                    ...
                    url: "<?php echo route('feed-reject') ?>",
                    method: 'POST',
                    data: {db_id:db_id,  _token:token},
                    success: function(data) {
                        //alert(data);
...
if (checkBox.checked == true){
...

    {
        ...
        $.ajax({
            ...
            url: "<?php echo route('popular-fapprove') ?>",
...

    {
        ...
        $.ajax({
            ...
            url: "<?php echo route('popular-freject') ?>",
