...
<head>
    ...
    <title>{{ App\Models\tblSystemSettigs::systemname('systemname') }} |Feed  Category Management</title>
                ...
                <div class="mdk-drawer-layout__content page">
                    ...
                    <div class="container-fluid page__heading-container">
                        <div class="page__heading d-flex align-items-center justify-content-between">
                            <h4 class="m-0">New Feed Category</h4>

                            <a href="{{ url('/feedcategory') }}"><button type="button" class="btn btn-warning"><i class="fa fa-step-backward"></i>&nbsp;Back</button></a>
                        </div>
                    </div>
                    ...
                    <div class="container-fluid page__container">
                        <div class="row no-gutters">
                            <div class="col-md-12">
                                <div class="card">
                                  <form action="{{ url('/post-feedcategory') }}" id="form_sample_1" method="post" enctype="multipart/form-data" >
                                  {{ csrf_field() }}
                                    <div class="card-form__body card-body">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-11">
                                                <label for="fname">Feed Category</label>
                                                <input id="fname" type="text" class="form-control" placeholder="Enter Feed Category" name="category"   required="">
                                        ...
                                        <input type="hidden" name="createdat" value="<?php echo date('Y-m-d'); ?>">
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <input type="submit" class="btn btn-success" value="Save Feed Category"/>
                                    </div>
                                  </form>
                                </div>
                            </div>
