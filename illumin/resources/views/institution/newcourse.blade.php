...
<head>
    ...
    <title>{{ App\Models\tblSystemSettigs::systemname('systemname') }} Admin | Course Management</title>
...
<body class="layout-default">
                ...
                <div class="mdk-drawer-layout__content page">
                    ...
                    <div class="container-fluid page__heading-container">
                        <div class="page__heading d-flex align-items-center justify-content-between">
                            <h4 class="m-0">New Course</h4>

                            <a href="{{ url('/course-management') }}"><button type="button" class="btn btn-warning"><i class="fa fa-step-backward"></i>&nbsp;Back</button></a>
                        </div>
                    </div>
                    ...
                    <div class="container-fluid page__container">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                  <form action="{{ url('/post-course') }}" id="form_sample_1" method="post" enctype="multipart/form-data" >
                                  {{ csrf_field() }}
                                    <div class="card-form__body card-body">
                                        ...
                                        <div class="form-group row" id="chpater-row{{$k}}" @if($k != '1') style="display: none;" @endif>
                                            <div class="col-md-4 col-lg">
                                                ...
                                                <input id="course{{ $k }}" type="text" class="form-control" placeholder="Enter Course Name here" name="coursename{{ $k }}" value="">
                                            </div>
                                            <div class="col-md-4 col-lg">
                                                <label for="fname">Course Short Name</label>
                                                <input id="courseshortname{{ $k }}" type="text" class="form-control" placeholder="Enter Course Short Name here" name="courseshortname{{ $k }}" value="" >
                                            </div>
                                            <div class="col-md-4 col-lg">
    ...
    <script type="text/javascript">
        ...
        function removerow(x)
        {
            ...
            document.getElementById('courseshortname'+x).value = '';
