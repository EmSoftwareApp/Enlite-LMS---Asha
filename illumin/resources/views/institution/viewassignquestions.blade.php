                ...
                <div class="mdk-drawer-layout__content page">
                    ...
                    <div class="container-fluid page__heading-container">
                        <div class="page__heading d-flex align-items-center justify-content-between">
                            ...
                            <a  onclick="window.close();"><button type="button" class="btn btn-warning"><i class="fa fa-step-backward"></i>&nbsp;Close</button></a>
                        </div>
                    </div>
                    ...
                    <div class="container-fluid page__container">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                  <form action="" id="form_sample_1" method="post" enctype="multipart/form-data" onSubmit="">
                                  {{ csrf_field() }}
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <input type="submit" onclick="window.close();" class="btn btn-success" value="Close"/>
                                    </div>
                                  </form>
                                </div>
                            </div>
