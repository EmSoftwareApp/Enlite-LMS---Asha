                ...
                <div class="mdk-drawer-layout__content page">
                    ...
                    <div class="container-fluid page__heading-container">
                        <div class="page__heading d-flex align-items-center justify-content-between">
                            <h4 class="m-0">New News Category</h4>
                    ...
                    <div class="container-fluid page__container">
                        <div class="row">
                            <div class="col-md-11">
                                <div class="card">
                                  <form action="{{ url('/post-newscategory') }}" id="form_sample_1" method="post" enctype="multipart/form-data" >
                                  {{ csrf_field() }}
                                    <div class="card-form__body card-body">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-11">
                                                ...
                                                <input id="fname" type="text" class="form-control" placeholder="Enter Category Here" name="labels"   required="">
