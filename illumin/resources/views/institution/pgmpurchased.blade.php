...
<head>
    ...
    <title>{{ App\Models\tblSystemSettigs::systemname('systemname') }} | Program Purchased</title>
                                                ...
                                                <table id="example" class="display" style="width:100%">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style="width: 90%; text-align: left;">Purchaded Prgrams</th>
                                                            ...
                                                            <td>
                                                                <div class="media align-items-center">
                                                                    <div class="media-body">
                                                                        <span class="js-lists-values-employee-name">{{ App\tblProgram::programfinder($object->prgrmid, 'id', 'programname') }}</span>
                                                                    </div>
                                                                </div>
                                                            </td>
