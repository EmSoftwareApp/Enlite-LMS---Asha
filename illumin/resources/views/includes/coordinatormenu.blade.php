                        ...
                        <div class="sidebar sidebar-light sidebar-left bg-white" data-perfect-scrollbar>
                            ...
                            <div class="sidebar-block p-0">
                                ...
                                <ul class="sidebar-menu mt-0">
                                    ...
                                    <li class="sidebar-menu-item @if($url == 'coordinatorhome') active @endif">

                                        <a class="sidebar-menu-button" href="{{ url('/coordinatorhome') }}">
                                    ...
                                    <li class="sidebar-menu-item @if($url == 'coordinatortasks') active @endif">

                                        <a class="sidebar-menu-button" href="{{ url('/coordinatortasks') }}">
                                            ...
                                            <span class="sidebar-menu-text">Coordinate to Faculties</span>
