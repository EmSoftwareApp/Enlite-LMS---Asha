    ...
    <span class="sidebar-menu-text">Announcements</span>
                                    ...
                                    <li class="sidebar-menu-item @if(($url == 'course-management') || ($url == 'new-course') || ($url == 'view-course')) active @endif">
                                        ...
                                        <a class="sidebar-menu-button" href="{{ url('/course-management') }}">
                                            ...
                                            <span class="sidebar-menu-text">Stream</span>
                                    ...
                                    <li class="@if(($url == 'student-batch') || ($url == 'new-batch') || ($url == 'view-batch') || ($url == 'student-batch-find') || ($url == 'student-assign-batch') || ($url == 'view-assignstudent-details') || ($url == 'student-assign-batch-find')) active @endif sidebar-menu-item">
...
<ul class="nested @if(($url == 'feedcategory') || ($url == 'writing-program')) active @endif">



    <li class="@if(($url == 'feedcategory') || ($url == 'new-subject') || ($url == 'view-subject')) active @endif submenu">

        <a class="sidebar-menu-button" href="{{ url('/feedcategory') }}">
    ...
    <li class="@if(($url == 'labels') || ($url == 'new-label') || ($url == 'view-label')) active @endif submenu">

        <a class="sidebar-menu-button" href="{{ url('/labels') }}">
    ...
    <li class="@if(($url == 'feeds') || ($url == 'new-feed') || ($url == 'view-feed')) active @endif submenu">

        <a class="sidebar-menu-button" href="{{ url('/feeds') }}">
            ...
            <span class="sidebar-menu-text">Feed</span>
...
<li class="sidebar-menu-item @if(($url == 'newscategory') || ($url == 'new-newscategory') || ($url == 'view-newscategory')|| ($url == 'newsdetails'))
                     ) active @endif">
                        ...
                        <ul class="nested @if(($url == 'newscategory') || ($url == 'new-newscategory') || ($url == 'view-newscategory')|| ($url == 'newsdetails'))  active @endif">
                            ...
                            <li class="@if(($url == 'newscategory') || ($url == 'new-newscategory') || ($url == 'view-newscategory')) active @endif submenu">

                                <a class="sidebar-menu-button" href="{{ url('/newscategory') }}">
                                    ...
                                    <span class="sidebar-menu-text"> News Category </span>
                            ...
                            <li class="@if(($url == 'newsdetails')) active @endif submenu">

                                <a class="sidebar-menu-button" href="{{ url('/newsdetails') }}">

                                    <i class="fa fa-newspaper-o sidebar-menu-icon sidebar-menu-icon--left" aria-hidden="true"></i>
                                    ...
                                    <li class="sidebar-menu-item @if(($url == 'free-video') || ($url == 'new-free-video') || ($url == 'view-free-video')) active @endif">
                                        ...
                                        <a class="sidebar-menu-button caret" href="{{ url('/material-management') }}">
