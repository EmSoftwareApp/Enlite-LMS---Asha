            ...
            <div class="home-banner text-white mb-4">
                <div class="container page__container">
                    ...
                    <div data-aos="fade-down" data-aos-duration="400" data-aos-delay="400" data-offset="-100">
                        <a class="btn btn-light btn-lg mr-1" href="fixed-student-courses.html">View Lessons</a>
                        <a class="btn btn-success btn-lg" href="fixed-student-courses.html">Contact</a>
                    </div>
                </div>
            </div>
            ...
            <div class="container page__container">
                    ...
                    <div class="col-md-3">
                        <div class="card card__course" data-aos="fade-up" data-offset="-100">
                            <div class="card-header card-header-large card-header-dark bg-dark d-flex justify-content-center">
                                ...
                                <a class="card-header__title justify-content-center align-self-center d-flex flex-column" href="{{ url('/course-details/'.$object->id) }}">
                                    @if($object->image == '')
                            ...
                            <div class="p-3">
                                <div class="d-flex align-items-center">
                                    <a href="{{ url('/course-details/'.$object->id) }}" class="text-body" style="text-decoration: none;">
                                        <p class="h6 m-0">{{ $object->programname }}</p>
                                    </a>
                                </div>
                                <div class="mb-2">
                                    <span class="mr-2">
                                ...
                                <div class=" justify-content-around">
                                        ...
                                        <div class="mb-2 text-muted d-flex align-items-center align-self-center">
                                            <small class="mr-3 d-flex align-items-center">
                                                ...
                                                <span class="ml-1">{{ App\Models\tblCourse::totalvideos($object->id) }} Lessons </span>
                                            </small>
                                            <small class="d-flex align-items-center">
                                                <i class="fa fa-clock"></i>
                                                <span class="ml-1">
                                                    {{ str_pad($object->time_hh, 2, "0", STR_PAD_LEFT) }} Hours
                                                </span>
                                            </small>
                                        </div>
                                    </div>
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="{{ url('/course-details/'.$object->id) }}" class="btn btn-primary ml-auto">GO</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 d-flex align-items-center  flex-row-reverse" data-aos-duration="500" data-aos="fade-right">
                        <div class="avatar avatar-xl ml-3">
                            <span class="bg-primary border avatar-title rounded-circle text-center text-white">
                                <strong class="fa fa-mobile-alt"></strong>
                            </span>
                        </div>
                        <div class="text-right">
                            <strong>To Simplify distance learning</strong>
                            <p class="m-0">This Allows you to access your e-learning courses from anywhere, anytime.</p>
                        </div>
                    </div>
                    <div class="col-md-6 d-flex align-items-center" data-aos-duration="500" data-aos="fade-left">
                        <div class="avatar avatar-xl mr-3">
                            <span class="bg-primary border avatar-title rounded-circle text-center text-white">
                                <strong class="fa fa-rocket"></strong>
                            </span>
                        </div>
                        <div>
                            <strong>Reduced recurring expenses</strong>
                            <p class="m-0">Recurring expenses will be less by implementing LMS.</p>
                        </div>
                    </div>
                </div>
                <div class="row mb-4">
                    <div class="col-md-6 d-flex align-items-center  flex-row-reverse" data-aos-duration="500" data-aos="fade-right">
                        <div class="avatar avatar-xl ml-3">
                            <span class="bg-primary border avatar-title rounded-circle text-center text-white">
                                <strong class="fa fa-users"></strong>
                            </span>
                        </div>
                        <div class="text-right">
                            <strong>Easy to organize and manage</strong>
                            <p class="m-0">You can store all of your e-learning materials in one location.</p>
                        </div>
                    </div>
                    <div class="col-md-6 d-flex align-items-center" data-aos-duration="500" data-aos="fade-left">
                        <div class="avatar avatar-xl mr-3">
                            <span class="bg-primary border avatar-title rounded-circle text-center text-white">
                                <strong class="fa fa-building"></strong>
                            </span>
                        </div>
                        <div>
                            <strong>Reduced infrastructure</strong>
                            <p class="m-0">This eliminates the need of classroom facility rental and purchase of classroom supplies.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-4">
                    <div class="col-md-6 d-flex align-items-center  flex-row-reverse" data-aos-duration="500" data-aos="fade-right">
                        ...
                        <div class="text-right">
                            <strong>Less expenses and overhead</strong>
                            <p class="m-0">It reduces the learning & development cost comparing to classroom method.</p>
                        </div>
                    </div>
                    <div class="col-md-6 d-flex align-items-center" data-aos-duration="500" data-aos="fade-left">
                        <div class="avatar avatar-xl mr-3">
                            <span class="bg-primary border avatar-title rounded-circle text-center text-white">
                                <strong class="fa fa-people-carry"></strong>
                            </span>
                        </div>
                        <div>
                            <strong>Faculty Outsourcing</strong>
                            <p class="m-0">Recruiting remote faculties may cutdown on expenses when compared to permanent hiring.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-4">
                    <div class="col-md-6 d-flex align-items-center  flex-row-reverse" data-aos-duration="500" data-aos="fade-right">
                        <div class="avatar avatar-xl ml-3">
                            <span class="bg-primary border avatar-title rounded-circle text-center text-white">
                                <strong class="fa fa-laptop"></strong>
                            </span>
                        </div>
                        <div class="text-right">
                            <strong>Less Administration overhead</strong>
                            <p class="m-0">The ability to manage and administrate the learning function is very easy.</p>
                        </div>
                    </div>
                    <div class="col-md-6 d-flex align-items-center" data-aos-duration="500" data-aos="fade-left">
                        <div class="avatar avatar-xl mr-3">
                            <span class="bg-primary border avatar-title rounded-circle text-center text-white">
                                <strong class="fa fa-chart-bar"></strong>
                            </span>
                        </div>
                        <div>
                            <strong>One time investment</strong>
                            <p class="m-0">With one time investment LMS brings you profit in all ways.</p>
                        </div>
                    </div>
                </div>
