...
<head>
    ...
    <title>{{ App\Models\tblSystemSettigs::systemname('systemname') }} | Profile</title>
            ...
            <div class="container page__heading-container">
                ...
                <div class="page__heading d-flex align-items-center justify-content-between">
                    ...
                    <div>
                        ...
                        <p class="text-muted m-0">{{ App\Models\tblSystemSettigs::systemname('systemname') }} Student</p>
                            ...
                            <div class="border-bottom">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <?php $pro_pic = Auth::user()->image; ?>

                                        @if($pro_pic == '')

                                        <img src="{{ asset('assets/images/avatar/avatar5.png') }}" alt="About {{ Auth::user()->name }}" width="100" class="rounded-circle">

                                        @else

                                        <img src="<?php echo asset($pro_pic); ?>" alt="About {{ Auth::user()->name }}" width="100" height="100" class="rounded-circle">
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled list-skills">
                                        ...
                                        <li>
                                            ...
                                            <div class="text-dark-gray"><st{{ App\Models\%</strong></div>
                    ...
                    <div class="col-md-9">
                                ...
                                <div class="card card-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <?php $count = DB::table('tbl_user_program_payments')->where(['userid' => Auth::user()->id, 'payment_type' => '1'])->count(); ?>

                                            <h4 class="m-0 bold">{{ $count }}</h4>
                                ...
                                <div class="card card-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <a href="#" class="text-muted mb-2">Test Taken</a>
                        ...
                        <div class="container page__heading-container">
                            ...
                            <div class="page__heading d-flex align-items-center justify-content-between">
                                ...
                                <a href="{{ url('/courses') }}" class="btn btn-success ml-3">Go to Courses <i class="material-icons">arrow_forward</i></a>
                        ...
                        <div class="row">
                            ...
                            <?php
                                ...
                                $time = App\Models\tblProgram::programfinder($object->prgrmid, 'id', 'regtime');
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="card card__course">
                                    ...
                                    <div class="card-header card-header-large card-header-dark bg-dark d-flex justify-content-center">
                                        ...
                                        <a class="card-header__title  justify-content-center align-self-center d-flex flex-column" href="{{ url('/course-enroll/'.$time) }}">

                                            <span><i class="fa fa-graduation-cap" style=" font-size: 36px; color: #95f912;"></i></span>

                                            <span class="course__title"></span>

                                            <span class="course__subtitle">{{ App\Models\tblProgram::programfinder($object->prgrmid, 'id', 'programname') }}</span>
                                    ...
                                    <div class="p-3">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <strong class="h5 m-0">₹ {{ App\Models\tblProgram::programfinder($object->prgrmid, 'id', 'amount') }}</strong>

                                            <a href="{{ url('/course-enroll/'.$time) }}" class="btn btn-primary ml-auto">Go</a>
                            ...
                            <?php
                                ...
                                $batchenddate = App\Models\tblProgram::batchendate($batches->batchid, $userid);
                            ...
                            @if($batchenddate >= $today)
                             ...
                             <?php
                                 ...
                                 $agents1 = DB::table('tbl_program_batch_assigns')->where(['batch' => $batches->batchid])->get(); 

                                foreach ($agents1 as $agent1) { 

                                    $time = App\Models\tblProgram::programfinder($agent1->program, 'id', 'regtime');

                                    $progmcount =  App\Models\tblProgram::multiprogramfinder($userid, $agent1->program);
                                ...
                                <div class="card card__course">
                                    ...
                                    <div class="card-header card-header-large card-header-dark bg-dark d-flex justify-content-center">
                                        ...
                                        <a class="card-header__title  justify-content-center align-self-center d-flex flex-column" href="{{ url('/course-enroll/'.$time) }}">
                                            ...
                                            <span class="course__subtitle">{{ App\Models\tblProgram::programfinder($agent1->program, 'id', 'programname') }}</span>
                                    ...
                                    <div class="p-3">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <strong class="h4 m-0">₹ {{ App\Models\tblProgram::programfinder($agent1->program, 'id', 'amount') }}</strong>
