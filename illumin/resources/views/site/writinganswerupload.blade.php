...
<?php
  ...
  $writing_id = Request::segment(2);
$pgm = Request::segment(3);
...
<div class='row'>
  ...
  <div class='col-sm-12 course-section'>
    ...
    <!--<div class='section-title' data-release-date="" data-days-until-dripped="0" data-is-dripped-by-date="" data-course-id="156515">
     ...
     <form id="uploadForm" action="{{url('answer-upload')}}" method="post" enctype="multipart/form-data" >
      {{ csrf_field() }}
<input type="hidden" name="writing_id" id="writing_id" value="{{$writing_id}}">
<input type="hidden" name="student_id" id="userid" value="{{$userid}}">
<input type="hidden" name="pgm" id="pgm" value="{{$pgm}}">
...
<div class="col-sm-9">
<input name="userImage" type="file" class="inputFile" /></div></div>
<div class="form-group">
