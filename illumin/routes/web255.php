...
//Route::get('/following', [UserController::class, 'followingme']);
Route::get('/', [UserCourseController::class, 'courses']);
//Route::get('/',  [UserCourseController::class, 'home']);
...
Route::get('/home',  [StudentSigninController::class, 'home']);
